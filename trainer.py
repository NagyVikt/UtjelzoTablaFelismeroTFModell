...
input_image_path = '/path/to/your/input_image.png'  # Replace with the path to your input image
base_save_dir = '/path/to/your/base/directory'  # Replace with your base directory path

# The CSV data you've provided
csv_data = [
[27,26,5,5,22,20,20],
[28,27,5,6,23,22,20],
[29,26,6,5,24,21,20],
...
[131,119,12,11,120,109,20],
[166,152,15,14,152,139,20],
[29,31,5,6,24,26,20],
[31,30,6,5,25,25,20],
[31,31,5,6,26,26,20],
[33,31,6,5,28,25,20],
...
[92,86,8,7,84,79,20],
[100,95,9,9,92,87,20],
[106,99,10,9,97,91,20],
[117,118,7,11,107,108,20],
...
[74,71,7,7,68,65,20],
[88,84,8,7,81,77,20],
[106,100,10,8,97,92,20],
[124,119,11,10,114,109,20],
...
with open(output_csv_path, mode='w', newline='') as file:
    ...
    for idx, (width, height, roi_x1, roi_y1, roi_x2, roi_y2) in enumerate(csv_data):
        # Resize the image to the desired width and height
        resized_image = cv2.resize(input_image, (width, height))
        
        # Define the filename with the specific naming convention
        filename = f"{class_id}_{idx:05d}.png"
